...
IvyTrader is an automated stock research platform that combines market data, news, social sentiment, machine learning forecasting, LLM-based interpretation, and multi-agent decision workflows in one system.
...
![Analysis Page](./pic/picture2.png)
...
- **Find similar events**  
  ...
  ![Similar Events](./pic/picture4.png)
...
## 4. Sentiment Page
![Sentiment Page](./pic/picture8.png)
