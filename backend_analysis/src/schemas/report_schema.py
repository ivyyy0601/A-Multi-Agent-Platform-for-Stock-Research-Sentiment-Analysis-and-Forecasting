...
class Fundamentals(BaseModel):
    """Fundamentals block (US stocks: financials, growth, dividends)."""

    model_config = ConfigDict(extra="allow")

    report_date: Optional[str] = None
    revenue: Optional[Union[int, float]] = None
    net_profit: Optional[Union[int, float]] = None
    operating_cash_flow: Optional[Union[int, float]] = None
    roe: Optional[Union[int, float]] = None
    revenue_yoy: Optional[Union[int, float]] = None
    net_profit_yoy: Optional[Union[int, float]] = None
    gross_margin: Optional[Union[int, float]] = None
    ttm_dividend_per_share: Optional[Union[int, float]] = None
    ttm_dividend_yield: Optional[Union[int, float]] = None
    ttm_dividend_count: Optional[Union[int, float]] = None
...
class AnalysisReportSchema(BaseModel):
    ...
    market_sentiment_reasoning: Optional[str] = None
