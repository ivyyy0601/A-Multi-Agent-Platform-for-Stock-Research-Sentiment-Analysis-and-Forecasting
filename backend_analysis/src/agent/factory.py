...
def get_tool_registry():
    ...
    from src.agent.tools.ivytrader_tools import IVYTRADER_TOOLS
    from src.agent.tools.rag_tools import RAG_TOOLS
    # search_tools (search_stock_news / search_comprehensive_intel) removed —
    # intelligence now comes exclusively from Adanos API (pre-loaded in context)

    registry = ToolRegistry()
    for tool_fn in ALL_DATA_TOOLS + ALL_ANALYSIS_TOOLS + ALL_MARKET_TOOLS + ALL_BACKTEST_TOOLS + IVYTRADER_TOOLS + RAG_TOOLS:
