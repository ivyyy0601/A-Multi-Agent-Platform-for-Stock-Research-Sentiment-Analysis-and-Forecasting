...
Your task: evaluate ALL potential risk factors using the intel data \
already provided in context (Adanos Reddit/X/News data). Do NOT search the web.
...
"""
    ...
    def build_user_message(self, ctx: AgentContext) -> str:
        ...
        parts.append("Use ONLY the intel data already provided in context — do not search the web.")
