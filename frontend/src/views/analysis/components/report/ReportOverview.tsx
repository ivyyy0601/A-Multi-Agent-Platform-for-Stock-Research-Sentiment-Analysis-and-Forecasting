...
export const ReportOverview: React.FC<ReportOverviewProps> = ({
  ...
  const getPriceChangeColor = (changePct: number | undefined): string => {
    ...
    if (changePct > 0) return 'text-[#26a69a]'; // green = up
    if (changePct < 0) return 'text-[#ef5350]'; // red = down
          ...
          <Card variant="gradient" padding="md">
            ...
            <div className="border-t border-white/5 pt-5">
              ...
              <p className="mt-2 whitespace-pre-wrap text-left text-[15px] leading-7 text-white max-w-[62ch]">
                {summary.analysisSummary || 'No analysis summary available'}
              </p>
            </div>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card variant="bordered" padding="sm" hoverable>
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1.5">
                  <h4 className="text-[11px] font-medium uppercase tracking-[0.16em] text-success">Recommendation</h4>
                  <p className="text-sm leading-6 text-white">
                    {summary.operationAdvice || 'No recommendation available'}
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card variant="bordered" padding="sm" hoverable>
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1.5">
                  <h4 className="text-[11px] font-medium uppercase tracking-[0.16em] text-warning">Trend Forecast</h4>
                  <p className="text-sm leading-6 text-white">
                    {summary.trendPrediction || 'No forecast available'}
                  </p>
                </div>
              </div>
            </Card>
