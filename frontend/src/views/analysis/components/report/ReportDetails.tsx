  ...
  return (
    <Card variant="bordered" padding="md" className="text-left">
      <div className="mb-3 flex items-baseline gap-2">
        ...
        <h3 className="text-base font-semibold text-white mt-0.5">Data Traceability</h3>
      </div>
      ...
      <div className="space-y-2">
        ...
        {details?.rawResult && (
          <div>
            ...
            >
              <span className="text-xs text-white">Raw Analysis Result</span>
              <svg
        ...
        {details?.contextSnapshot && (
          <div>
            <button
              ...
              className="w-full flex items-center justify-between p-2.5 rounded-lg bg-elevated hover:bg-hover transition-colors"
            >
              <span className="text-xs text-white">Analysis Snapshot</span>
              <svg
